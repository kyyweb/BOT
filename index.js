...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('MASUKAN NOMOR DENGAN AWALAN 62 JANGAN MASUKIN NAMA HADZZ GANTENG G BISA BANG:\n');
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6282136536302' + "@s.whatsapp.net", { text: `BOT ON YAH BANG HADZ BELI PANEL DI HADZ AJA BUY SCNYA JUGA DI HADZ` });
}
